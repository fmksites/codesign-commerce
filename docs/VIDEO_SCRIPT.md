...
| 0:25–0:36 | Five discovered tools | “This existing page registers five focused WebMCP tools for reading, option discovery, temporary proposals, colourway creation, and validation.” |
...
| 2:28–2:42 | Repository | “The public Apache-2.0 repository contains the real package, both examples, tests, evals, security boundary, and reproducible instructions.” |
