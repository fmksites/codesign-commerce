...
| Public foundation | `IN_PROGRESS` | Clean clone of commit `13a168d` passed `npm ci`, 62 tests, strict source/test typecheck, core plus both example builds, public-boundary over 88 tracked candidates, 27 docs, 24 eval-corpus cases, browser-bundle digest `sha256:3723b4937086323c1536406f2072efbd54da702ec63d7c2f94d32ea768f101f6`, and an empty final status; Apache-2.0 is present | Complete public source and both examples are locally reproducible. Hosted CI and the public remote repository remain external gates. |
...
| Deterministic QA | `IN_PROGRESS` | 62 public tests pass across core and tote contracts; private typecheck/build, 12 focused page tests, and 95-pass/1-skip full Designer E2E pass; clean clone passes | Expanded safety/property cases, final all-adapter matrix, and final release clone remain. |
| WebMCP evals | `NOT_STARTED` | — | — |
| Actual-browser verification | `IN_PROGRESS` | Public/private North Form and public tote five-tool scenarios pass in the actual WebMCP-capable in-app browser; tote coupled-rule failure, pre-proposal visibility, committed-state isolation, human UI, mobile renderer, and Revert inspected | Native-size tote desktop, broader negative prompts, final immutable-build, and deployed checks remain. |
